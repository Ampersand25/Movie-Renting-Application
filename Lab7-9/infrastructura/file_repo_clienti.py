...
class FileRepositoryClienti(RepositoryClienti):
    ...
    def __citeste_tot_din_fisier(self):
        with open(self.__filename, 'r') as f:
            ...
            for line in lines:
                ...
                if line != '':
                    parts = line.split(';')
                    client = Client(int(parts[0]), parts[1], int(parts[2]))
                    self._clienti.append(client)

    def __append_client_fisier(self, client_nou):
        with open(self.__filename, 'a') as f:
            f.write(str(client_nou.get_id_client()) + ';' + client_nou.get_nume() + ';' + str(client_nou.get_cnp()) + '\n')

    def __scrie_tot_in_fisier(self):
        with open(self.__filename, 'w') as f:
            for client in self._clienti:
                f.write(str(client.get_id_client()) + ';' + client.get_nume() + ';' + str(client.get_cnp()) + '\n')
    ...
    def adauga(self, client_nou):
        ...
        RepositoryClienti.adauga(self, client_nou)
        self.__append_client_fisier(client_nou)
    ...
    def __len__(self):
        ...
        self.__citeste_tot_din_fisier()
        return RepositoryClienti.__len__(self)

    def cauta_dupa_id(self, _id_client):
        ...
        self.__citeste_tot_din_fisier()
        return RepositoryClienti.cauta_dupa_id(self, _id_client)
    ...
    def get_all(self):
        ...
        self.__citeste_tot_din_fisier()
        return RepositoryClienti.get_all(self)
    ...
    def modifica(self, client_nou):
        ...
        self.__citeste_tot_din_fisier()
        RepositoryClienti.modifica(self, client_nou)
    ...
    def sterge_dupa_id(self, _id_client):
        ...
        self.__citeste_tot_din_fisier()
        RepositoryClienti.sterge_dupa_id(self, _id_client)
        self.__scrie_tot_in_fisier()